...
namespace Managers
{
    public class InputManager : MonoBehaviour
    {
        ...
        {
            return Resources.Load<CD_InputData>("Data/CD_InputData").InputData;
        }
                ...
                if (_isTouchingPlayer)
                    if (_mousePosition != null)
                    {
                        ...
                        InputSignals.Instance.onInputDragged?.Invoke(new HorizontalInputParams
                        {
                            ...
                            HorizontalInputClampSides = new Vector2(_inputData.ClampSides.x, _inputData.ClampSides.y)
                        });
                    }
        }
        ...
        private void CasualInput()
        {
            ...
            InputSignals.Instance.onJoystickMovement?.Invoke(new JoystickInputParams
            {
